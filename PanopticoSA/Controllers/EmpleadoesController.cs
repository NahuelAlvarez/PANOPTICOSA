...
namespace PanopticoSA.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(PanopticoSAContext context)
        {
            _context = context;
        }
        ...
        {
            var panopticoSAContext = _context.Empleado.Include(e => e.IdPersonaNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpleado,Sueldo,IdPersona")] Empleado empleado)
        {
