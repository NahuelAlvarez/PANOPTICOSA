...
namespace PanopticoSA.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(PanopticoSAContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPersona,Dni,Nombre,Apellido,IdDomicilio,FechaNacimiento,Telefono,Email")] Persona persona)
        {
