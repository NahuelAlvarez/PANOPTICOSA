...
namespace PanopticoSA.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(PanopticoSAContext context)
        {
            _context = context;
        }
        ...
        {
            var panopticoSAContext = _context.Cliente.Include(c => c.IdPersonaNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,IdPersona")] Cliente cliente)
        {
